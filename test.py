...
from utils import selected_image,print_string,selected,print_answers,validate
...
def layout(Tab,checklist,checklist_key,tab_num,Image,col_list,image_actions):
    ...
    with Tab:
        ...
        with outer_cols[2]:
            click_type=st.radio('Click Type',['On','Off','Check'],key='Radio'+str(checklist_key),label_visibility='collapsed',on_change=validate,args=(checklist_key,))
        with outer_cols[3]:
