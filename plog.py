...
for j,i in enumerate(st.session_state.num_checklist_list):
    st.session_state.master_list[st.session_state.keys[st.session_statenum_checklist_list[j]]]=[]
    st.session_state.answer[st.session_state.keys[st.session_statenum_checklist_list[j]]]=[]
